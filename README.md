...
- `tests/test_book.py`：图书按关键词和分类查询
- `tests/test_borrow.py`：学生借出、无库存加入预约队列
- `tests/test_reservation.py`：学生提交预约、取消预约、重复取消失败
- `tests/test_admin_flow.py`：管理员借书、还书、逾期生成违期记录、罚金缴清
